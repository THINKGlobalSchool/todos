<div class="elgg_horizontal_tabbed_nav margin_top">
	...
	<?php 
		...
		echo "<li class='" . ($due == "past" ? 'selected ' : '') . " edt_tab_nav'>" 
				. elgg_view('output/url', array('href' => elgg_get_site_url() . $vars['return_url'] . "?due=past", 
												'text' => elgg_echo("todo:label:pastdue"), 
												'class' => 'todo')) . 
			 "</li>"; 
			
		echo "<li class='" . ($due == "nextweek" ? 'selected ' : '') . " edt_tab_nav'>" 
				. elgg_view('output/url', array('href' => elgg_get_site_url() . $vars['return_url'] . "?due=nextweek", 
												'text' => elgg_echo("todo:label:nextweek"), 
												'class' => 'todo')) . 
			 "</li>";
			
		echo "<li class='" . ($due == "future" ? 'selected ' : '') . " edt_tab_nav'>" 
				. elgg_view('output/url', array('href' => elgg_get_site_url() . $vars['return_url'] . "?due=future", 
